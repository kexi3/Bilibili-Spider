...
### （四）生成词云图  
#### 1、源码
运行 wordcloud.py 脚本，使用词频统计结果生成词云图并保存为HTML文件“wordcloud.html”。  
#### 2、结果  
词云图:  
...
##### （1）词频统计分析详解  
###### ① 交通与职业相关
* 出租车（548次） ：作为讨论的主要对象，高频出现的“出租车”一词反映了用户对传统出租车行业的关注。用户可能在讨论无人驾驶技术如何影响现有的出租车服务，或者比较无人驾驶与传统出租车的优劣。  
* 司机（863次） ：与“无人驾驶”对比，用户可能在探讨司机职业的未来，讨论中包括担忧和期待，例如无人驾驶是否会完全取代人类司机，以及司机转型的可能性。  
* 网约车（450次） ：讨论无人驾驶技术对网约车行业的影响，用户可能在讨论无人驾驶网约车的优缺点，和传统网约车的对比。  
* 外卖（93次） ：这可能涉及无人驾驶在外卖配送中的应用，用户在探讨无人驾驶是否会应用于外卖行业，及其可能带来的影响。  
* 失业（205次）、就业（102次）  ：用户对无人驾驶技术对就业市场的影响表示担忧，特别是对驾驶员等相关岗位的失业问题。
###### ② 技术与公司
* AI/ai（483次）、无人驾驶（234次） 、无人（198次） 、人工智能（93次） ：这些词汇表明用户对无人驾驶技术及其背后的AI技术有着浓厚的兴趣，讨论中可能包括技术原理、发展现状和未来前景。 
* 企业（229次）、科技（223次）、小米（21次） 、华为（22次） ：用户讨论不同科技公司在无人驾驶领域的进展和竞争。例如，华为和小米作为领先的科技公司，其在无人驾驶领域的成就和动向引起了广泛关注。
###### ③ 担忧与反对
* 保护（92次）、安全（57） ：用户对无人驾驶技术的现存问题和局限性进行了讨论，可能包括技术上的瓶颈、安全隐患和政策法规等方面的挑战。  
* 取代（152次） 、普通人（145次）、淘汰（83次） ：反映了用户对无人驾驶技术可能取代现有工作岗位的担忧。  
* 失业（205次） 、出路（70次） 、饭碗（34次）：可能是对失业问题的调侃，表达了对未来生活的不确定性和担忧。
###### ④ 前景与期望
* 发展（401次）、进步（223次） 、市场（142次） ：用户讨论无人驾驶技术的发展需求和市场前景，可能包括对政策支持、技术创新和市场需求的讨论。  
* 便宜（620次） 、价格（208次） ：用户期待无人驾驶技术能够降低出行成本，提高运输服务的性价比。  
* 安全（57次） ：安全性是用户关注的重点，讨论中可能包括无人驾驶技术如何保证乘客和行人的安全。
###### ⑤ 情感与态度
...
###### ⑥ 具体案例分析  
* 萝卜（145次） ：特指萝卜快跑这个品牌或技术，用户可能在讨论其在无人驾驶领域的应用和表现。
* * 滴滴（182次） ：作为网约车行业的代表，用户可能在讨论滴滴在无人驾驶技术中的表现和未来，或将其与其他无人驾驶技术进行比较。
###### ⑦ 地域与文化  
* 武汉（53次） ：讨论视频或弹幕中提到的特定城市，该城市在无人驾驶技术方面的进展。萝卜快跑首先在武汉运营，在无人驾驶技术的应用上有一些独特的实践和案例。  
...
### （五）情感分析/生成情感分布图
#### 1、源码
运行 sentiment_analysis.py 脚本和 sentiment_distribution.py 脚本，对弹幕数据进行情感分析，计算平均情感分数并保存分析结果，生成情感分布图并保存为HTML文件“sentiment_distribution.html”。  
#### 2、结果
* 每条弹幕的情感倾向：  
...
<img src="https://github.com/kexi3/Bilibili-Spider/blob/main/Inserted%20images/sentiment_score.png" width="380" height="150">

##### （2）、情感分布与总体趋势
从情感分布来看，弹幕情感呈现多样化，但整体略偏向正面：  

* 负面情感（非常负面 + 负面）：36454条  
* 中性情感：3926条  
* 正面情感（正面 + 非常正面）：7481条  
平均情感分数为0.52，接近中性，但略偏正面。这表明用户对无人驾驶技术有较多的期待和正面情绪，尽管也有不少负面的评价和期待。

##### （3）、负面情感分析
* 非常负面（3558条） ：高度负面的评论可能包含对无人驾驶技术的强烈批评和不满，反映出用户对技术的不信任或对其带来负面影响的强烈担忧。这些评论可能涉及到安全隐患、失业问题以及技术失败等。  
* 负面（2896条） ：负面评论则可能表达了用户的质疑和不安。例如，对无人驾驶技术的现状不满意，认为其在短期内难以成熟应用，或对其可能导致的社会问题表示担忧。
##### （4）、中性情感分析
* 中性（3926条） ：中性的评论往往是描述性和客观性的，用户可能在讨论无人驾驶技术的现状、原理、具体应用等，而不带有明显的情感倾向。这些评论对了解用户的理性分析和中立观点非常有价值。
##### （5）、正面情感分析
* 正面（3087条） ：正面评论反映了用户对无人驾驶技术的认可和期待。用户可能赞赏技术的先进性、对未来生活的便利性及其在解决当前交通问题上的潜力。  
* 非常正面（4394条） ：高度正面的评论可能表达了用户的强烈支持和乐观态度。例如，认为无人驾驶技术将带来革命性的变化，彻底改变交通和出行方式，提高生活质量。
##### （6）、具体情感案例
...
##### （7）、总结
通过情感分析，可以看出用户对无人驾驶技术的态度复杂且多样。尽管整体情感略偏正面，但中立和负面的评论也占据了很大比例。负面情感主要源自对技术不成熟、潜在安全问题及其对就业市场影响的担忧。而正面情感则集中在对技术进步的认可和对未来便利生活的期待。  
